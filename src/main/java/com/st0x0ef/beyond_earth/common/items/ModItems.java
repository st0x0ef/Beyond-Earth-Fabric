...
public class ModItems {
    ...
    public static final Item NETHERITE_SPACE_HELMET = registerItemGroupNormal("netherite_space_helmet",  new NetheriteSpaceSuit.Helmet(ModArmorMaterials.NETHERITE_SPACE_SUIT_MATERIAL, new FabricItemSettings().fireproof()));
    public static final Item NETHERITE_SPACE_SUIT = registerItemGroupNormal("netherite_space_suit",  new NetheriteSpaceSuit.Suit(ModArmorMaterials.NETHERITE_SPACE_SUIT_MATERIAL, new FabricItemSettings().fireproof()));
    public static final Item NETHERITE_SPACE_PANTS = registerItemGroupNormal("netherite_space_pants",  new NetheriteSpaceSuit.Pants(ModArmorMaterials.NETHERITE_SPACE_SUIT_MATERIAL, new FabricItemSettings().fireproof()));
