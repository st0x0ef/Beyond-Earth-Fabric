...
public class LargeSmokeParticle extends ExplosionSmokeParticle {
    protected LargeSmokeParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
    ...
    public static class ParticleFactory implements net.minecraft.client.particle.ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new LargeSmokeParticle(world, x, y, z, velocityX, velocityY, velocityZ, spriteSet);
        }
    }
}
