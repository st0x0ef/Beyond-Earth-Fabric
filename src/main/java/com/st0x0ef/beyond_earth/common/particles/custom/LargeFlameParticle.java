...
public class LargeFlameParticle extends ExplosionSmokeParticle {
    public LargeFlameParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
    ...
    public static class ParticleFactory implements net.minecraft.client.particle.ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new LargeFlameParticle(world, x, y, z, velocityX, velocityY, velocityZ, spriteSet);
        }
    }
}
