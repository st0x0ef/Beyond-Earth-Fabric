...
public class ModItemGroups {
    ...
    public static final ItemGroup FLAGS_ITEM_GROUP = FabricItemGroup.builder(new Identifier(BeyondEarth.MOD_ID, "tab_flags"))
            .icon(() -> new ItemStack(Items.LIGHT_BLUE_BANNER)).build();
    ...
    public static final ItemGroup BASICS_ITEM_GROUP = FabricItemGroup.builder(new Identifier(BeyondEarth.MOD_ID, "tab_basics"))
            .icon(() -> new ItemStack(Items.STICK)).build();
